                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                            <tr>
                                ...
                                @include('livewire.includes.table-sortable-th',['name' => 'is_admin', 'displayName' => 'Role'])
                                @include('livewire.includes.table-sortable-th',['name' => 'created_at', 'displayName' => 'Joined'])
                                <th scope="col" class="px-4 py-3" wire:click="setSortBy('name')">Last update</th>
